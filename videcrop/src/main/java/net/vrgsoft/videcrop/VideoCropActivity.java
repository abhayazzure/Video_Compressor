...
public class VideoCropActivity extends AppCompatActivity implements VideoPlayer.OnProgressUpdateListener, VideoSliceSeekBarH.SeekBarChangeListener {
    ...
    private AppCompatImageView mIvPlay, mIvAspectRatio, mIvDone;
    private VideoSliceSeekBarH mTmbProgress;
    private CropVideoView mCropVideoView;
    private TextView mTvProgress, mTvDuration, mTvAspectCustom, mTvAspectSquare, mTvAspectPortrait, mTvAspectLandscape, mTvAspect4by3, mTvAspect16by9, mTvCropProgress;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crop_module);
...
//        mTmbProgress.setDuration(duration);
    ...
    private void findViews() {
        ...
        mIvPlay = (AppCompatImageView) findViewById(R.id.ivPlay);
        mIvAspectRatio = (AppCompatImageView) findViewById(R.id.ivAspectRatio);
        mIvDone = (AppCompatImageView) findViewById(R.id.ivDone);
        mTvProgress = (TextView) findViewById(R.id.tvProgress);
        mTvDuration = (TextView) findViewById(R.id.tvDuration);
        mTmbProgress = (VideoSliceSeekBarH) findViewById(R.id.tmbProgress);
        mAspectMenu = (View) findViewById(R.id.aspectMenu);
        mTvAspectCustom = (TextView) findViewById(R.id.tvAspectCustom);
        mTvAspectSquare = (TextView) findViewById(R.id.tvAspectSquare);
        mTvAspectPortrait = (TextView) findViewById(R.id.tvAspectPortrait);
        mTvAspectLandscape = (TextView) findViewById(R.id.tvAspectLandscape);
        mTvAspect4by3 = (TextView) findViewById(R.id.tvAspect4by3);
        mTvAspect16by9 = (TextView) findViewById(R.id.tvAspect16by9);
        mProgressBar = (ProgressView) findViewById(R.id.pbCropProgress);
        mTvCropProgress = (TextView) findViewById(R.id.tvCropProgress);
    }
    ...
    private void handleMenuVisibility() {
        ...
        mAspectMenu.animate().translationY(isAspectMenuShown ? 0 : Resources.getSystem().getDisplayMetrics().density * 400).alpha(isAspectMenuShown ? 1 : 0).setInterpolator(interpolator).start();
    }
...
//        }
    ...
    private void handleCropStart() {
        ...
        if (mFFMpeg.isSupported()) {
            ...
            String[] cmd = {"-y", "-ss", start, "-i", inputPath, "-t", duration, "-vf", crop, outputPath};
